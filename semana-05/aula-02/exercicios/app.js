...
alert(`O valor do desconto ${valor * 5  / 100 }`)
...
let idadePessoa = parseInt(idadeEmDias / 365);
let idadeMes = parseInt((idadeEmDias % 365) / 30);
let idadeDias = parseInt((idadeMes % 30) / 30);
